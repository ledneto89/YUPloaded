...
return Padding(
padding: const EdgeInsets.all(24),
child: Center(child: Text('No loads match your search.', style: GoogleFonts.barlow(fontSize: 14, color: textMuted))),
);
}
return Column(
...
if (u != null) {
await FirebaseFirestore.instance.collection('users').doc(u.uid).update({'totalLoads': FieldValue.increment(-1)});
}
},
