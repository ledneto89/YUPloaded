              ...
              child: Column(children: [
                        ...
                        child: _rateTab == 0
                            ...
                            : _yupNope(
                                () async {
                                  ...
                                  if (url != null) setState(() { _rateConUrl = url; _rateStatus = true; });
                                  else setState(() => _rateStatus = true);
                                },
                ...
                _buildDocSlot(icon: Icons.article, title: 'BILL OF LADING', status: _bolStatus,
                  onYup: () async {
                    ...
                    setState(() { if (url != null) _bolUrl = url; _bolStatus = true; });
                  },
                ...
                const SizedBox(height: 10),
                _buildDocSlot(icon: Icons.check_circle, title: 'PROOF OF DELIVERY', status: _podStatus,
                  onYup: () async {
                    final url = await _uploadSinglePhoto('pod');
                    setState(() { if (url != null) _podUrl = url; _podStatus = true; });
                  },
                  onNope: () => setState(() => _podStatus = false)),
